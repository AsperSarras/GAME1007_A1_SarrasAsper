...
{
	SDL_Rect r = MathManager::ConvertFRect2Rect(object2);
	return SDL_HasIntersection(&object1, &r);
}

bool CollisionManager::AABBCheck(const SDL_FRect& object1, const SDL_FRect& object2)
{
	SDL_Rect r1 = MathManager::ConvertFRect2Rect(object1);
	SDL_Rect r2 = MathManager::ConvertFRect2Rect(object2);
...
{
	SDL_Rect r = MathManager::ConvertFRect2Rect(object1);
...
{
	SDL_Rect r1 = MathManager::ConvertFRect2Rect(object1);
	SDL_Point p1 = MathManager::ConvertFPoint2Point(object2_start);
	SDL_Point p2 = MathManager::ConvertFPoint2Point(object2_end);
...
{
	SDL_Point p = MathManager::ConvertFPoint2Point(object1);
	SDL_Rect r = MathManager::ConvertFRect2Rect(object2);
